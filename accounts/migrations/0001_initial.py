    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('admin', 'Admin'), ('college', 'College'), ('college_coordinator', 'College_Coordinator')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affiliated_college', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.college')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coordinator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.coursecoordinator')),
            ],
        ),
        migrations.CreateModel(
            name='College_Course',
